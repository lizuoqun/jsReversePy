...
const dom = new JSDOM('<!DOCTYPE html><p></p>', {url: 'http://iwencai.com/unifiedmobile/?q=5g&queryType=stock#/result?question=5g&queryType=stock'});
...
location = {
  'ancestorOrigins': {},
  'href': 'http://iwencai.com/unifiedwap/result?w=5g&querytype=stock',
  ...
  'search': '?w=5g&querytype=stock',
  'hash': ''
};

var TOKEN_SERVER_TIME = 1734743663.440;
!function (n, t) {
  !function () {
    var r, e, a;
    r = e = a = n;
    ...
    var Fn = r[45], Yn = Wn(c[58], e[46]), jn = v(s[59], u[60]), Hn = Wn(r[47], s[61]), $n = s[62], Un = s[63],
      Vn = u[2], Xn = [new u[27](r[48]), new u[27](c[64])], Gn = [new e[47](ot(a[49])), new u[27](ot(a[50], u[65]))],
    ...
    !function (n) {
      ...
      var o, i, c;
      o = i = c = u;
      var s = c[223], f = t[201], l = i[224], p = o[225], d = t[202], h = i[92], g = e[203], w = o[226], m = c[110],
        I = c[223], y = !!r[65][r[135]], _, E, A, T, B, R;
...
console.log('cookiev.js loaded', window.exportD());

// A-HipJATItbFfY6inMKrBA8-8Kb-jlWAfwL5lEO23ehHqg_Yi95lUA9SCWPQ